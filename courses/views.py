...
from .models import Course_Table, Course_Checkout_Table
...
def checkout_form_submit(request):
    ...
    var_Course_Checkout_Table = Course_Checkout_Table(Name=Customer_Name, Email=Customer_Email, Number=Phone_Number, Course=getCourse)
